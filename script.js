...
const translations = {
  cs: {
    ...
    pricing: {
      ...
      card3Price: "3000 Kč",
      card3Item1: "Tréninkový plán na míru",
      card3Item2: "Denní možnost online komunikace",
      card3Item3: "Sledování progresu a úpravy tréninku",
      card3Item4: "Videokonzultace a analýza techniky",
    },
    about: {
  ...
  en: {
    ...
    pricing: {
      ...
      card3Price: "3000 CZK",
      card3Item1: "Tailored training plan",
      card3Item2: "Daily option for online communication",
      card3Item3: "Progress tracking and training adjustments",
      card3Item4: "Video consultation and technique analysis",
    },
    about: {
